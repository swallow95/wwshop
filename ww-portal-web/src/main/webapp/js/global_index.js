...
$("div.item").on("mouseleave",function(){
...
$(function(){
	...
	$(".rHot dd").on("mouseenter",function(){
    	if ($(this).find(".gWindow").length > 0){
			$(this).find(".hBtn").hide();
		}else{
			$(this).find(".hBtn").show();
	...
	$(".rHot dd").on("mouseleave",function(){
		$(this).find(".hBtn").hide();
		$(this).find("a.pname").removeClass("ddHover");
	});
	
	SFbest.Slide.init();
	$(".ajaxdata_index li").on("mouseenter",function(){
    	if ($(this).find(".gWindow").length > 0){
			$(this).find(".gBtn").hide();
		}else{
			$(this).find(".gBtn").show();
	...
	$(".ajaxdata_index li").on("mouseleave",function(){
		$(this).find(".gBtn").animate({top:"184px"},300);
	});
})
